...
<head>
    ...
    <title>TotalBusiness - @yield('title')</title>
    ...
    <!-- Elegent CSS -->
    <link href="{{asset('css/elegent.min.css')}}" rel="stylesheet">
                    ...
                    <div class="menubar-top d-flex justify-content-between align-items-center flex-sm-wrap flex-md-wrap flex-lg-nowrap mt-sm-15">
                        ...
                        <div class="header-contact d-flex">
                            <div class="phone-icon">
                                <img src="{{asset('images/icon-phone.png')}}" class="img-fluid" alt="">
                            </div>
                                ...
                                <div class="cart-items">
                                    <div class="cart-float-single-item d-flex">
                                        ...
                                        <div class="cart-float-single-item-image">
                                            <a href="single-product.html"><img src="{{asset('images/products/product01.jpg')}}" class="img-fluid" alt=""></a>
                                        </div>
                                    ...
                                    <div class="cart-float-single-item d-flex">
                                        <span class="remove-item"><a href="#"><i class="fa fa-times"></i></a></span>
                                        <div class="cart-float-single-item-image">
                                            <a href="single-product.html"><img src="{{asset('images/products/product02.jpg')}}" class="img-fluid" alt=""></a>
                                        </div>
                                        <div class="cart-float-single-item-desc">
            ...
            <div class="row"> --}}
                {{-- <div class="col-lg-4 col-md-12 col-sm-12 mb-sm-20 mb-xs-20">
                    ...
                    <div class="newsletter-title">
                        <h1>
                            <img src="{{asset('images/icon-newsletter.png')}}" alt="">
                            Send Newsletter
                        </h1>
                    </div>
                </div> --}}
            ...
            <div class="row align-items-md-center align-items-sm-center">
                ...
                <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="payment-info text-center text-md-right">
                        <p>Allow payment base on <img src="{{asset('images/payment-icon.png')}}" class="img-fluid" alt=""></p>
                    </div>
                            ...
                            <div class="product-small-image-list">
                                <div class="nav small-image-slider" role="tablist">
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="single-slide-tab-1" href="#single-slide1"><img src="{{asset('images/products/product01.jpg')}}"
                                                                                                                class="img-fluid" alt=""></a>
                                    </div>
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="single-slide-tab-2" href="#single-slide2"><img src="{{asset('images/products/product02.jpg')}}"
                                                                                                                class="img-fluid" alt=""></a>
                                    </div>
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="single-slide-tab-3" href="#single-slide3"><img src="{{asset('images/products/product03.jpg')}}"
                                                                                                                class="img-fluid" alt=""></a>
                                    </div>
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="single-slide-tab-4" href="#single-slide4"><img src="{{asset('images/products/product04.jpg')}}"
                                                                                                                alt=""></a>
                                    </div>
                                </div>
                            </div>
